...
const EmailSending = () => {
    ...
    const emailsending = async (details) => {
        ...
        try {
            ...
            const deleteresponse = await fetch("https://day44backend.vercel.app/activate/delete", {
                method: "DELETE",
            ...
            if (deleteData.message === "Successfully URL token deleted") {
                ...
                const emailresponse = await fetch("https://day44backend.vercel.app/activate", {
                    method: "POST",
                    body: JSON.stringify(details),
                    headers: {
    ...
    useEffect(() => {
        const validation = async () => {
            ...
            try {
                ...
                const response = await fetch(`https://day44backend.vercel.app/verify/${params.id}`, {
                    method: "PUT",
                    body: JSON.stringify(),
                    headers: {
                        "Content-Type": "application/json"
